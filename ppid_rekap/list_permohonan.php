                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <a href="form_permohonan.php" class="btn btn-primary btn-user">Tambah Permohonan Informasi</a>
                                    <br/><br/>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                   ...
                                                   tp.cara_mendapatkan_info, tp.status FROM transaksi_permohonan AS tp,pemohon AS p WHERE p.email=tp.email AND p.email='$mail'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="detail_permohonan.php?id=<?php echo $row['id_permohonan'];?>" class="btn btn-primary btn-user">Detail</a></td>
                                                </tr>
                                               <?php }?>
                                            </tbody>
                                        </table>
