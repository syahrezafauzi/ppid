            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Rekapitulasi Pelayanan Informasi Publik Tahun 2023</h1>
                        <form action="">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <?php 
                                                $select = "SELECT COUNT(id_permohonan) FROM transaksi_permohonan WHERE year(tgl_permohonan)=2023";
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Pengajuan Keberatan</div>
                                                 <?php 
                                                $select2 = "SELECT COUNT(id_keberatan) FROM transaksi_keberatan WHERE year(tgl_permohonan)=2023";
                                                $get2 = mysqli_query($conn,$select2); 
                                                $row2 = mysqli_fetch_row($get2); 
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php // echo $row2[0];?>1</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                $select3 = "SELECT COUNT(id_sengketa) FROM transaksi_sengketa WHERE year(tgl_permohonan)=2023";
                                                $get3 = mysqli_query($conn,$select3); 
                                                $row3 = mysqli_fetch_row($get3); 
                                                ?>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php // echo $row3[0];?>1</div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                ...
                                                <?php 
                                                $select4 = "SELECT COUNT(id_permohonan) FROM transaksi_permohonan WHERE status='Ditolak' AND year(tgl_permohonan)=2023";
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                   Rata-rata Pelayanan : <b>5 Hari 23 jam 6 menit 7 detik</b><br/>
                                
                                   Pelayanan Tercepat : <b>1 hari 5 jam 30 detik</b><br/>
                                
                                   Pelayanan Terlama : <b>25 Hari 9 jam 27 menit 11 detik </b>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                   ...
                                                   $select_query = "SELECT * FROM transaksi_permohonan WHERE year(tgl_permohonan)=2023 ORDER BY tgl_permohonan DESC";
