                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                   Silakan <a href="#" class="btn btn-primary btn-user">Terima</a> atau <a href="#" class="btn btn-primary btn-user btn-warning">Tolak</a> permohonan yang masuk.
                                    <br/><br/>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                 <?php 
                                                   ...
                                                   tujuan, status FROM transaksi_permohonan WHERE status='Proses validasi' ORDER BY id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                    if($row['status'] == 'Proses validasi'){
                                                    ?>
                                                    <td><a href="form_validate.php?id=<?php echo $row['id_permohonan'];?>" class="btn btn-primary btn-user">Terima</a></td>
                                                    <td><a href="form_deny.php?id=<?php echo $row['id_permohonan'];?>" class="btn btn-primary btn-user btn-warning">Tolak</a></td>
                                                    <?php } ?>
                                                </tr>
                                               <?php }?>
                                            </tbody>
