                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <br/>
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Ajukan Keberatan</h1>
                                    </div>
                                    ...
                                    <div><br/><br/></div>
                                    <div class="text-center">
                                        Belum memiliki akun? <a class="small" href="register.php">klik disini</a>
                                    </div>
                                    <?php 
                                    if (isset($_POST['submit'])) {
                                        $email = mysqli_real_escape_string($conn, $_POST['email']); 
                                        $pass = $_POST['password'];
                                        $sql = mysqli_query($conn, "SELECT email, pass FROM pemohon WHERE email = '$email'");
                                        ...
                                        if (mysqli_num_rows($sql) > 0) {
                                            ...
                                            if (password_verify($pass, $password)) {
                                                ...
                                                echo '<script>window.location.href="list_keberatan.php"</script>';
